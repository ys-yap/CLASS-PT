...
cdef class Class:
    ...
    def pk(self,double k,double z, int no_wiggle=False, double alpha_rs=1.0):
        ...
        cdef double large_for_logs_matter = 10000. #YS: Logs
        cdef double large_for_logs_big = 1000000.
        cdef double large_for_logs_small = 20.
